...
if(isset($_POST['Login']))
{
	...
	{
		session_start();
		$row=mysql_fetch_row($que1);
		$_SESSION['tempcampuser']=$user;
		$_SESSION['uid']=$row[0];
		...
		if($count2>0)
		{
			...
			if($count3>0)
			{
				...
				if($que2=="" && $ans2=="")
				{
					header("location:camp_files/camp_step/camp_step3/Secret_Question2.php");
				}
				else
				{
				 	
					session_start();
					$_SESSION['campuser']=$user;
					...
					header("location:camp_files/camp_home/Home.php");
				}
				
			}
			else
			{
				header("location:camp_files/camp_step/camp_step2/Secret_Question1.php");
			}
		}
		else
		{
			...
			if($Gender=="Male")
			{
				header("location:camp_files/camp_step/camp_step1/Step1_Male.php");
			}
			else
			{
				header("location:camp_files/camp_step/camp_step1/Step1_Female.php");
			}
		}
	}
	else
