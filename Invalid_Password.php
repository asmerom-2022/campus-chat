...
<LINK REL="SHORTCUT ICON" HREF="camp_files/camp_title_icon/campuschat.ico" />
	<style>
		#singup_button
		{
			background:#69A74E;
...
<div style="position:absolute;left:0;top:0; height:13%; width:100%; z-index:-1; background:#339966">   </div>
<div style="position:absolute;left:13.5%; top:3.3%; font-size:45; font-weight:900; color:#FFFFFF; font-weight:bold;"> <font face="mycampFont">  CAMPUS CHAT </font> </div>

<div style="position:absolute;left:13.6%; top:14.8%;"> <a href="create new.php" style="text-decoration:none;"> <input type="button" value="Sign Up" id="singup_button">    </a> </div>
...
<div style="position:absolute; left:27.4%; top:28.2%;">  <font size="4"> campuschat Login </font>  </div>
...
<form  method="post">
	...
	<div style="position:absolute;left:49%;top:71.7%; "> <a href="index.php" style="color:#3B5998;text-decoration:none;"> Sign up for campus chat</a> </div>
